...
print("3D Cursor Location:", cursor_location)

# Bounding box corners (8 points)
...
# Get the first corner of the bounding box
bbl_corner = bbox_corners_np[0]

# Shift the bounding box corners so the first corner is at the origin
bbox_corners_shifted = bbox_corners_np - bbl_corner

# Now, normalize the forklift points relative to the shifted bbox
# Get the size of the shifted bbox
bbox_size = bbox_corners_shifted[7] - bbox_corners_shifted[0]
...
data = {
    ...
    "semantic_points": [],
    "bbox_corners_shifted": bbox_corners_shifted.tolist() # Add the shifted bbox corners
}
